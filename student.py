...
class Student:
    def __init__(self, root):
        ...
        # First image
        img = Image.open(r"C:\Users\nayan\Desktop\Python Projects\Face Recognition System\images\images.jpg")
        ...
        img_right = Image.open(r"C:\Users\nayan\Desktop\Python Projects\Face Recognition System\images\focused-study-group-stockcake.jpg")
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
            ...
            # Load predefined data on face frontals from OpenCV
                face_classifier = cv2.CascadeClassifier(r"C:\Users\nayan\Desktop\Python Projects\Face Recognition System\haarcascade_frontalface_default.xml")
